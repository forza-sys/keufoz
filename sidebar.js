            ...
            `;
             ...
             menuHTML = `
                 ...
                 <div style="position: absolute; bottom: 20px; left: 0; width: 100%; padding: 0 15px;">
                     <a href="#" onclick="sessionStorage.removeItem('foz_auth'); window.location.href='${base}login.html';" style="display: flex; align-items: center; gap: 15px; color: #111827; text-decoration: none; font-weight: 600; font-size: 0.9rem; padding: 12px 15px; border-radius: 8px; transition: background 0.2s;">
