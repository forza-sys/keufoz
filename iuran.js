...
function updateKPIs() {
    ...
    if (kpi3Sub) {
      ...
      kpi3Sub.innerHTML = `<table style="width:100%; border:none !important; margin:0; padding:0; border-spacing:0; font-size:0.75rem; color:#9ca3af; background:transparent;"><tr><td style="padding:0; padding-bottom:4px; white-space:nowrap; border:none !important; border-bottom:none !important; background:transparent;">${lunas} terbayar <span style="color:#cbd5e1; margin:0 4px;">|</span> ${belum} belum</td></tr><tr><td style="padding:0; color:#6b7280; font-size:0.65rem; white-space:nowrap; border:none !important; border-bottom:none !important; background:transparent;">Nas <strong style="color:#374151;">${nPct}%</strong> <span style="color:#cbd5e1; margin:0 4px;">|</span> Prov <strong style="color:#374151;">${pPct}%</strong> <span style="color:#cbd5e1; margin:0 4px;">|</span> Kab <strong style="color:#374151;">${kPct}%</strong></td></tr></table>`;
    }
